...
if(mobileCheck()) {
    ...
    class mobileButton {
        constructor(label, position, downFunc, upFunc) {
            ...
            this.button.style.left = position.x + "%";
            this.button.style.top = position.y + "%";
            this.button.style.width = position.width + "%";
            this.button.style.height = position.height + "%";
            this.button.className = "mobileButton";
            this.button.addEventListener("touchstart",downFunc);
            this.button.addEventListener("touchend",upFunc);
            this.button.addEventListener("touchcancel",upFunc);
